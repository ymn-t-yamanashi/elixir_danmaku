...
この索引は、`danmaku` の Markdown 文書を分類してたどりやすくするための正式な入口である。
正本の文書は `docs/` 配下に置いて運用する。
...
- [FIRST_MILESTONE.md](project/FIRST_MILESTONE.md)
...
- [DOC_REVIEW_PROFILE.md](review/DOC_REVIEW_PROFILE.md)
- [CODEX_REVIEW_PROFILE.md](review/CODEX_REVIEW_PROFILE.md)
- [DESIGNER_PROFILE.md](review/DESIGNER_PROFILE.md)
- [MUSIC_PROFILE.md](review/MUSIC_PROFILE.md)
